...
public class UpdateFragment extends AppCompatDialogFragment {
    DialogListener1 dialogListener;
        ...
        builder.setView(view)           // sets custom view to be the content of dialog
                ...
                .setPositiveButton("Update", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {            // take data from Edit text and pass it
                        ...
                        dialogListener.updateData(name, address, phone);
    ...
    public interface DialogListener1 {
        void updateData(String name, String address, String phone);
    }
    ...
    public void onAttach(Context context) {
        ...
        try {
            dialogListener = (DialogListener1) context;
